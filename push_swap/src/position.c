...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/05 13:15:25 by daraz             #+#    #+#             */
/*   Updated: 2023/12/05 13:39:15 by daraz            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* get_position:
*	We assign a position to each element of a stack from top to bottom
*	in ascending order.
*	Example stack:
*		value:		 3	 0	 9	 1
*		index:		[3]	[1]	[4]	[2]
...
/* get_lowest_index_position:
	We get the current position of the element with the lowest index
	within a stack.
*/
...
/* get_target:
*	We pick the best target position in stack A for the given index of
...
/* get_target_position:
*	We assign a target position in stack A to each element of stack A.

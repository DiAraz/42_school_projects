...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/05 15:16:47 by daraz             #+#    #+#             */
/*   Updated: 2023/12/05 15:17:58 by daraz            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* do_rev_rotate_both:
*	We reverse rotate both stack A and B until one of them is in position.
...
/* do_rotate_both:
*	We rotate both stack A and B until one of them is in position.
...
/* do_rotate_a:
*	We rotate stack A until it is in position. If the cost is negative,
...
/* do_rotate_b:
*	We rotate stack B until it is in position. If the cost is negative,
*	the stack will be reverse rotated, if it is positive, it will be 
*	rotated.
*/
...
/* do_move:
*	We choose which move to make to get the B stack element to the correct
*	position in stack A.

...
<p align="center">
  <img src="https://github.com/DiAraz/DiAraz/blob/main/42_badges/philosopherse.png"/>
</p>

Philosophers is a 42 school project designed around Edsger Dijkstra's famous dining philosophers problem. For the project, we must find a solution to the problem using threads and mutexes.
...
The algorithm must keep the philosophers alive as far as possible. The programs must take several parameters:
